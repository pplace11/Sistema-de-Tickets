...
const routes = [
    ...
    { path: '/entities', component: EntitiesView, meta: { requiresAuth: true, requiresOperator: true } },
    { path: '/entities/:id', component: EntityDetailView, meta: { requiresAuth: true, requiresOperator: true } },
    { path: '/contacts', component: ContactsView, meta: { requiresAuth: true, requiresOperator: true } },
    { path: '/contacts/:id', component: ContactDetailView, meta: { requiresAuth: true, requiresOperator: true } },
